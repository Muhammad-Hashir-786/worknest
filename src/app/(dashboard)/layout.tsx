...
export default async function DashboardLayout({
  ...
  return <div className="min-h-screen overflow-x-hidden bg-[#f7f7f6] lg:flex">
    <aside className="dashboard-sidebar sticky top-0 z-40 max-w-full overflow-hidden bg-[#151515] px-4 py-4 text-white shadow-lg shadow-black/10 lg:fixed lg:inset-y-0 lg:flex lg:w-72 lg:flex-col lg:px-5 lg:py-6 lg:shadow-none">
    ...
    <div className="min-w-0 flex-1 lg:ml-72"><main className="dashboard-main mx-auto max-w-[1440px] px-4 pb-24 pt-5 sm:px-8 sm:pb-8 lg:px-12 lg:py-10">{children}</main></div>
    <CommandPalette />
    <WorkNestGuide />
  </div>;
}
