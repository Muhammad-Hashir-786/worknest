...
function ActionCard({ action }: { action: GuideAction }) {
  ...
  if (state === "success") return <div className="mt-3 flex items-center gap-2 rounded-xl bg-emerald-50 px-3 py-2 text-xs font-semibold text-emerald-700">✓ Done. <span className="font-normal">The change is now in your workspace.</span></div>;
